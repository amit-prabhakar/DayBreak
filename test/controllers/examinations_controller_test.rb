...
class ExaminationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create examination" do
    assert_difference('Examination.count') do
      post examinations_url, params: { examination: { current: @examination.current, exposure: @examination.exposure, name: @examination.name, study: @examination.study, voltage: @examination.voltage } }
    end
  ...
  test "should update examination" do
    patch examination_url(@examination), params: { examination: { current: @examination.current, exposure: @examination.exposure, name: @examination.name, study: @examination.study, voltage: @examination.voltage } }
